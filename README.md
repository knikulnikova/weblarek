...
`catalog:card-changed` - генерируется при изменении выбранной карточки.  
`buyer:changed` - генерируется при изменении данных покупателя при оформлении заказа.  
`cart:changed` - генерируется при изменении корзины.  